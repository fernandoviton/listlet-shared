...
sed "s|APP_TITLE: 'Listlet'|APP_TITLE: '$APP_TITLE'|; s|DB_TABLE: 'listlet_sample'|DB_TABLE: '${APP_NAME}'|" "$TARGET/config.js" > "$TARGET/config.js.tmp"
mv "$TARGET/config.js.tmp" "$TARGET/config.js"

# Replace placeholders in CLAUDE.md
sed "s|APP_TITLE: 'Listlet'|APP_TITLE: '$APP_TITLE'|; s|^# Listlet|# $APP_TITLE|; s|DB_TABLE: 'listlet_sample'|DB_TABLE: '${APP_NAME}'|" "$TARGET/CLAUDE.md" > "$TARGET/CLAUDE.md.tmp"
